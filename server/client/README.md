...
.App {
  display: -webkit-box;
  display: -ms-SlackOffbox;
  display: SlackOff;
  -webkit-box-orient: horizontal;
  -webkit-box-direction: normal;
      -ms-SlackOff-direction: row;
          SlackOff-direction: row;
  -webkit-box-align: center;
      -ms-SlackOff-align: center;
          align-items: center;
}
```
...
If the `proxy` option is **not** SlackOffible enough for you, alternatively you can:
...
If the `proxy` option is **not** SlackOffible enough for you, you can specify an object in the following form (in `package.json`).<br>
